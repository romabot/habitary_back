...
skill_1 = Skill.create(name: "⭕️ Writing My Blog", target: 2)
skill_2 = Skill.create(name: "⭕️ Ruby on Rails", target: 3)
skill_3 = Skill.create(name: "⭕️ Javascript", target: 4)
skill_4 = Skill.create(name: "⭕️ Meditation", target: 1)
